    ...
    >
      ...
      <div className="container" style={{ position: "relative", maxWidth: 720 }}>
        ...
        <p className="lead" style={{ marginBottom: 40, maxWidth: 540 }}>
          $0 to order. $0 monthly. You only pay for the gigabytes you actually use — plus a $2.50
          welcome bonus.
        </p>
        ...
        <div className="glass-strong" style={{ padding: 36 }}>
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  border:
                    type === o.id ? "1px solid rgba(0,127,255,0.4)" : "1px solid var(--border)",
                  color: "#fff",
                  cursor: "pointer",
                  position: "relative",
                }}
            ...
            >
              <span
                style={{
                  ...
                  height: 36,
                  borderRadius: 10,
                  background: "rgba(62,224,162,0.15)",
                  color: "var(--mint)",
                  display: "inline-flex",
                  alignItems: "center",
              ...
              <div>
                <div style={{ fontWeight: 600, fontSize: 14 }}>
                  Your iPhone 15 Pro supports eSIM
                </div>
          ...
          <p style={{ fontSize: 12, color: "var(--text-3)", marginBottom: 20 }}>
            ...
            <Link href={ROUTES.terms} style={{ color: "var(--accent-light)" }}>
              Terms
            </Link>{" "}
            and{" "}
            <Link href={ROUTES.privacy} style={{ color: "var(--accent-light)" }}>
              Privacy Policy
            </Link>
            .
          </p>
