      ...
      >
        ...
        <div
          style={{
            ...
            zIndex: 1,
            background:
              "linear-gradient(180deg, rgba(0,6,15,0.45) 0%, rgba(0,6,15,0.25) 50%, rgba(0,10,23,0.65) 85%, var(--bg-deep) 100%)",
          }}
          aria-hidden
        />
        ...
        <div
          className="container"
          style={{ position: "relative", zIndex: 3, paddingTop: 32, paddingBottom: 80 }}
        >
          <Link
            href={ROUTES.home}
            style={{
          ...
          <p className="caption" style={{ color: "#66b7ff", marginBottom: 20 }}>
            Field notes
          </p>
          ...
          <p className="lead" style={{ maxWidth: 520, margin: 0 }}>
            Travel data, eSIM tutorials, and the occasional industry exposé. Written by people who
            run the network.
          </p>
        </div>
      </section>
            ...
            {CATS.map((c) => (
              <button
                ...
                style={{
                  ...
                  fontWeight: 600,
                  borderRadius: 999,
                  border: `1px solid ${cat === c ? "#fff" : "rgba(255,255,255,0.08)"}`,
                  background: cat === c ? "#fff" : "rgba(255,255,255,0.04)",
                  color: cat === c ? "#000a17" : "#fff",
                  cursor: "pointer",
                }}
              >
                {c}
          ...
          {feature && (
            ...
            >
              <div
                style={{
                  aspectRatio: "16/10",
                  background: "linear-gradient(135deg, rgba(0,127,255,0.3), rgba(62,224,162,0.15))",
                  position: "relative",
                  overflow: "hidden",
                  display: "flex",
                  alignItems: "center",
              ...
              return (
                ...
                >
                  <div
                    style={{
                      aspectRatio: "16/10",
                      background: `linear-gradient(135deg, hsla(${(p.title.charCodeAt(0) * 7) % 360}, 60%, 35%, 0.4), rgba(10,15,30,0.6))`,
                      position: "relative",
                      overflow: "hidden",
                      display: "flex",
                      alignItems: "center",
                  ...
                  <div style={{ padding: 24, flex: 1, display: "flex", flexDirection: "column" }}>
                    <h3 className="ty-4" style={{ margin: "0 0 8px" }}>
                      {p.title}
                    </h3>
                    <p
                      style={{
