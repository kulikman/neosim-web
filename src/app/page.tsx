 ...
 * TODO: replace with full landing page design (hero, features, pricing).
 */
      ...
      <main className="w-full max-w-3xl rounded-2xl border border-zinc-200 bg-white p-10 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
        <div className="flex flex-col gap-6">
          ...
          <h1 className="text-3xl font-semibold tracking-tight text-zinc-950 sm:text-4xl dark:text-zinc-50">
            Your digital mobile operator for travel.
          </h1>
          <p className="max-w-2xl text-base leading-7 text-zinc-600 sm:text-lg dark:text-zinc-400">
            One eSIM. One ICCID for life. Pay per MB — only when you use data. Auto-switches
            operators as you cross borders.
          </p>
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <a
              href="https://github.com/kulikman/neosim"
              target="_blank"
              rel="noreferrer"
